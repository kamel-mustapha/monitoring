(() => {
  ...
  function ct(e) {
    ...
    for (let o of r) if (!t.includes(o) && (qt.forEach((s) => s(o)), o._x_cleanups)) for (; o._x_cleanups.length; ) o._x_cleanups.pop()();
    t.forEach((o) => {
      (o._x_ignoreSelf = !0), (o._x_ignore = !0);
    });
    for (let o of t)
      r.includes(o) ||
        (o.isConnected && (delete o._x_ignoreSelf, delete o._x_ignore, Ut.forEach((s) => s(o)), (o._x_ignore = !0), (o._x_ignoreSelf = !0)));
    t.forEach((o) => {
...
`
  ...
  function ft(e) {
    let t = [],
      r = (a) => t.push(a),
      [n, i] = Vt(e);
    return t.push(i), [{ Alpine: F, effect: n, cleanup: r, evaluateLater: x.bind(x, e), evaluate: I.bind(I, e) }, () => t.forEach((a) => a())];
  }
  function Sn(e, t) {
    let r = () => {},
      n = mt[t.type] || r,
  ...
  function ur() {
    document.body ||
      T("Unable to initialize. Trying to load Alpine before `<body>` is available. Did you forget to add `defer` in Alpine's `<script>` tag?"),
  ...
  function De(e, t, { during: r, start: n, end: i } = {}, o = () => {}, s = () => {}) {
    if (
      (e._x_transitioning && e._x_transitioning.cancel(), Object.keys(r).length === 0 && Object.keys(n).length === 0 && Object.keys(i).length === 0)
    ) {
      o(), s();
      return;
    }
  ...
  function M(e, t, r) {
    ...
    let i = n.get(r);
    i || n.set(r, (i = new Set())),
      i.has(D) || (i.add(D), D.deps.push(i), D.options.onTrack && D.options.onTrack({ effect: D, target: e, type: t, key: r }));
  }
  ...
  function Ue(e, t) {
    ...
    return (n, i, o) =>
      i === "__v_isReactive" ? !e : i === "__v_isReadonly" ? e : i === "__v_raw" ? n : Reflect.get(me(r, i) && i in n ? r : n, i, o);
  }
  var pi = { get: Ue(!1, !1) },
    bs = { get: Ue(!1, !0) },
    mi = { get: Ue(!0, !1) },
  ...
  function ln({ get: e, set: t }, { get: r, set: n }) {
    let i = !0,
      ...
      l = P(() => {
        ...
        i
          ? ((u = e()), n(u), (d = r()), (i = !1))
          : ((u = e()), (d = r()), (a = JSON.stringify(u)), (c = JSON.stringify(d)), a !== o ? ((d = r()), n(u), (d = u)) : (t(d), (u = d))),
          (o = JSON.stringify(u)),
          (s = JSON.stringify(d));
      });
    return () => {
